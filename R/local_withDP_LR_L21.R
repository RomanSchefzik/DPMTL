################################################################################
#' @title Solver of MTL with logistic loss and joint feature selection
#' @description Solver of MTL with logistic loss and joint feature selection
...
#' @details Solver of MTL with logistic loss for joint feature selection. \cr A list of options controlling the optimization procedure and specifying the differential privacy component based on a privacy parameter epsilon>0 can be provided via the \code{opts} argument:
#' \itemize{
...
#' 
#' @export  
LR_MTL_L21 <- function (X, Y, lam, C, opts=list(init=0,w0=NULL,tol=0.01,maxIter=50,ter=2,diffPrivEpsilon=NULL,nRunsSensitAn=100)){
